...
local mytable = gears.table or awful.util.table
...
globalkeys = mytable.join(
	...
	awful.key({ altkey, "Control" }, "l", function()
		os.execute("~/.local/bin/lockscreen.sh")
	...
	awful.key({ altkey }, "m", function()
		os.execute(
			string.format("pactl -- set-sink-mute 0 toggle", beautiful.volume.togglechannel or beautiful.volume.channel)
		)
		beautiful.volume.update()
